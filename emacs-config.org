...
#+begin_src elisp
  ...
  (setq org-capture-templates '(("j" "Add a journal entry" plain (function my/org-journal-find-location)
                                 "** %(format-time-string org-journal-time-format)\n%i%?")

                                ("t" "Add a TODO to the inbox" entry (file+headline org-default-notes-file "INBOX")
                                 "** TODO %?\n")))
#+end_src
