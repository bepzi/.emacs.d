...
(setq org-agenda-files '("~/decrypted/org"))
...
(setq org-capture-templates
  '(("t" "Add a task to the TODO list." entry
     (file+headline "~/decrypted/org/tasks.org" "Tasks")
     "* TODO %? %t")
    ("a" "Add an upcoming date to the calendar." entry
     (file+headline "~/decrypted/org/calendar.org" "Calendar")
     "* %? %t")
    ("s" "Add an entry to the \"Some Day\" category." entry
     (file+headline "~/decrypted/org/someday.org" "Some Day")
     "* %?")))
#+end_src
...
(use-package org-journal
  :defer t
  :custom (org-journal-dir "~/decrypted/org/journal")
